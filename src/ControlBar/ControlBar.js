...
// import { fa-youtube, faTrashAlt, faHeart } from '@fortawesome/free-solid-svg-icons';

class ControlBar extends Component {
  render() {
    return (
      <div className="ControlBar">
        {/* <div className="ControlBar__btn"><FontAwesomeIcon icon={ faYoutube }/></div>
        <div className="ControlBar__btn"><FontAwesomeIcon icon={ faHeart }/></div>
